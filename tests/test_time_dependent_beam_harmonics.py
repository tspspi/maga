...
"""Harmonic analysis regression test for the oscillating beam."""
...
class TestTimeDependentBeamHarmonics(unittest.TestCase):
    ...
    def test_time_dependent_beam_line_harmonics(self):
        ...
        fundamental_path = os.path.join(output_dir, 'oscillating_beam_line_fundamental.png')
        second_harmonic_path = os.path.join(output_dir, 'oscillating_beam_line_second_harmonic.png')
